...
$$ 
\ln(price) = 22.47 + 0.0001493 (sqft\_living) + 0.2405 (grade) + 0.1194 (bathrooms) + 0.06258 (view) + 0.02137 (condition) - 0.006042 (yr\_built)
$$
...
# Split data the f stands for the future non normalized data to run the ols to compare with
...
After some refinement, we were able to obtain a model with 6 predictors with a  moderate adjusted R^2 value of 0.6155, and an okay RMSE of 0.2659. 
